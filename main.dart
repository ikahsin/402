...
final List<double> PriceList = [120,140,180,200,214,230,260,278,291,331];
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text('Hapka'),
          titleTextStyle: TextStyle(color: Colors.lightGreen, fontSize: 30),
...
https://github.com/hopper313/ideal-WB.git